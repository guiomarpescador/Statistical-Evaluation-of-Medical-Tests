...
$$
Te covariates, $x_{\bar{D}_i}$ and $x_{D_j}$, are assumed to be independently and uniformly distributed on the $(-1,\,1)$ interval. For simplicity, we further assume that errors are normally distributed, that is, $\varepsilon_{\bar{D}_i}$, $\varepsilon_{D_j} \sim \mathcal{N}(0,\,1)$ for $i = 1, \dots, n_{\bar{D}}$ and $j = 1, \dots, n_D$.

...
## Penalised splines estimates functions
...
## Penalised splines roc function
...
legend(-2.2,2,ncol =1,legend=c("True AUC","Kernel Method","P-splines Method"), fill=c("black","blue2","red"), title="Legend", xpd=NA)
```
...
rownames(df) = c("n = 100", "n = 200", "n=300")
